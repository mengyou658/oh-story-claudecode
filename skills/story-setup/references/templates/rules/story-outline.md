...
0. **大纲生成要求**：其中包含三次大两难性时刻以及20个小的冲突(默认20个用户可以自己描述至少多少个冲突)(可以是自我或者外部爆发升级反转或者处理)以及一个清晰的道德前提。落盘于 `大纲/大纲.md`「全书体量与阶段总览 → 道德前提与冲突配额」；缺道德前提、大两难①②③或小冲突清单（须满 20 条）任一，视为大纲未完成、不得批产细纲。
