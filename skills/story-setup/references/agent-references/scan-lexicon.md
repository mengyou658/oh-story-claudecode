...
在当今时代、随着…的发展、在这个…的时代、众所周知、不言而喻、毋庸置疑、在…浪潮中、当我们谈论…的时候、不难发现、日新月异

## ZH · 连接 / 八股（1B）

不可否认、值得注意的是、需要指出的是、总而言之、综上所述、概括而言、换言之、换句话说、基于以上、在此基础上、接下来让我们、再者、一方面…另一方面…、不仅如此、更重要的是、从某种意义上说、客观来讲、坦白说、本质上、首先、其次、再次、此外、与此同时、由此可见、不难看出、总体来看、客观来说、在这个背景下

## ZH · 程度 / 虚壳（2–3）

非常、十分、极其、相当、特别、格外、真的、确实、的确、实在、一种、某种、一定的、相应的、一定程度上、值得关注的是、必须承认、让我们正视、需要明白的是、显著、大幅、极大地、持续、不断、深入、全面、有效、积极、稳步、充分、切实、至关重要、不可或缺、前所未有

> 短文旁路：每千字「非常/十分/其实/进行/一种」合计倾向 ≤3（见 story-deslop `shortform-sidepath.md`）。小说按成簇与密度，不硬套千字配额。空洞程度副词优先**真删**，不换成同义虚壳（见 fidelity-constraints）。
...
赋能、底层逻辑、闭环、抓手、共鸣、沉淀（空用）、跑通、复盘、拉齐、收敛、发散、辐射、引爆、撬动、加持、颗粒度、心智、链路、漏斗、增长飞轮、信息差、认知差、势位、深度链接、护城河、组合拳、赛道、势能、痛点、生态、格局、对齐

> 「底层逻辑」等若出现在**题材设定/力量体系**专名语境，按白名单或 C 级禁动保留，不因本表误删。AI/商业/技术主题叙述中上述词常为领域通用语——须成簇且代替具体事件才修（hanyu 领域误伤边界）。

## ZH · 无立场退让（1B · hanyu）

因人而异、视情况而定、各有优劣、需要综合考虑、具体情况具体分析、适合自己的才是最好的

> 叙述层把判断退回读者 = 空转。角色对话里的真实犹豫可留；作者/旁白万能退让 → 删或给具体判断。

## ZH · 结尾升华增补（1B · hanyu）

让我们共同期待、未来可期、任重而道远、在…的道路上、只有…才能…、携手共进、砥砺前行、书写…篇章、希望对您有所启发

> 与「排比/升华」簇合并扫描；章尾改动作/对话/悬念，不改议论文式「明确立场」硬收束（小说）。
