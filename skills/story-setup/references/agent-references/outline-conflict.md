...
|------------------|-----------|-----------|
| 定大纲冲突配额 / 道德前提 / 章级小冲突 | 大纲·细纲冲突配额（硬约束） | 冲突设计 |
...
- 道德前提先于冲突清单：一句可证伪的价值判断，三次大两难与 80 主清单小冲突都应能检验或冲击该前提；备选 20 条同理。
- 大两难 = 两边都不能无损放弃的选择；落在不同阶段，改写主线或人物关系。
- 小冲突 = 自我或外部；形态取爆发 / 升级 / 反转 / 处理；写入大纲编号清单并锚定落点（主清单 80 + 备选 20）。

**细纲生成要求：每章节都有一个小冲突(可以是自我或者外部爆发升级（反转或处理或打脸或突然想起重要的事情忘记处理或者其他的冲突）)**

- 每章「本章小冲突」必填；可兑现大纲清单条目，也可是章级新增的轻量冲突。
- 形态扩例：打脸、突然想起重要的事情忘记处理、以及其他未列尽的冲突类型。
...
- [ ] 大纲是否含清晰道德前提、三次大两难性时刻、80个主清单小冲突 + 20个备选
- [ ] 每章细纲是否各有一个可指认的小冲突（自我或外部；爆发/升级/反转/处理/打脸/想起忘办等）
