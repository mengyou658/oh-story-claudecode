...
| 中文原生套路（四字格/汇报腔/伪深度等） | `story-deslop/references/chinese-native-patterns.md`（模式 25–33；部署副本 `story-setup/references/agent-references/chinese-native-patterns.md`） |
| 机械量表阈值 | `story-deslop/references/slop-gauge-thresholds.md` |
...
- [ ] **无四字格/汇报腔成簇**：无连续四字格堆砌、扎实推进/形成闭环类公文动词组
- [ ] **无伪深度/套路开收**：无"本质上/值得深思/随着…的发展/展望未来/开启新篇章"
- [ ] **写前密度**：二分对照/路标词/关联句式/极值框架未超 generation-constraints 上限
